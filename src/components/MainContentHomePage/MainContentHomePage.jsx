              ...
              >
                ...
                {theme === "light" ? (
                  <m.g
                    ...
                    animate={theme === "light" ? "visible" : "hidden"}
                  >
                    <m.path variants={rayVariant} d="M49 1.5V11" />
                    <m.path
                      variants={rayVariant}
                      d="M82.5825 15.4175L75.885 22.115"
                    />
                    <m.path variants={rayVariant} d="M87 49H96.5" />
                    ...
                    <m.path variants={rayVariant} d="M49 87V96.5" />

                    <m.path
                      variants={rayVariant}
                      d="M22.115 75.885L15.4175 82.5825"
                    />
                    <m.path variants={rayVariant} d="M1.5 49H11" />
        ...
        <div className={styles.infoContainer}>
          ...
          <span className="iconContainer">
            <a href="https://twitter.com" target="_blank">
              <img src={twitterthemeIcon} alt="Twitter icon"></img>
            </a>
            ...
            <a href="https://linkedin.com" target="_blank">
              <img src={linkedinthemeIcon} alt="linkedin icon"></img>
            </a>
          </span>
          ...
          <div className={styles.MainContentButtonContainer}>
            <div className={styles.MainContentResumeButtonContainer}>
              <a href={CVFile} download>
                <button className={cn("hover", styles.MainContentButton)}>
                  Resume
                  {/* <GrMail /> */}
                  <svg
                    stroke="currentColor"
            ...
            <div className={styles.MainContentContactButtonContainer}>
              <a
                href="#contact"
                onClick={(e) => {
              ...
              >
                <button
                  className={cn("hover", styles.MainContentButton)}
