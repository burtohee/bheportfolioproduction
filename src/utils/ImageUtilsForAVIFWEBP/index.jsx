...
export const heroImageLargeAvif = heroImageLargeAVIF;
export const heroImageMediumAvif = heroImageMediumAVIF;
export const heroImageSmallAvif = heroImageSmallAVIF;
export const heroImageLargeWebp = heroImageLargeWEBP;
export const heroImageMediumWebp = heroImageMediumWEBP;
export const heroImageSmallWebp = heroImageSmallWEBP;
